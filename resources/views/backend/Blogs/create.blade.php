       ...
       <form action="{{route('blog.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
         ...
         <div class="form-group">
            ...
            <textarea name="l_desc" class="form-control summernote" placeholder="Enter Long Description" id="" cols="30" rows="10">Place <em>some</em> <u>text</u> <strong>here</strong></textarea>
