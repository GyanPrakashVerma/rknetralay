            ...
            <div class="col-md-2">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb" style="background-color:transparent!important;">
                        ...
                        <li class="breadcrumb-item active" aria-current="page" style="font-size:18px;color:white;">Blog</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<section>
    ...
    <h1 class="section_heading text-center">Blog</h1>
                ...
                <div class="col-lg-8 m-15px-tb">
                    <article class="article">
                        <div class="article-img">
                            <img src="{{ asset('blogs_img/'. $blog->images) }}" width="100%" height="auto" title="" alt="">
                        </div>
                ...
                <div class="col-lg-4 m-15px-tb blog-aside">
                    ...
                    <div class="widget widget-latest-post">
                        ...
                        <div class="widget-body">
                            @foreach ($bloggg as $bloggs)    
                            <div class="latest-post-aside media">
                                <div class="lpa-left media-body">
                                    <div class="lpa-title">
                                        <h5><a href="{{ route('blog',$bloggs->id) }}">{{ $bloggs->short_description??null}}</a></h5>
                                    </div>
                                    <div class="lpa-meta">
                                        <a class="name" href="#">
                                            {{ $bloggs->auther??null}}
                                ...
                                <div class="lpa-right">
                                    <a href="#">
                                        <img src="{{ asset('blogs_img/'. $bloggs->images??null) }}" width="100% " title="" alt="">
                                    </a>
                                </div>
                            </div>
                            @endforeach
