            ...
            <div class="col-md-2">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb" style="background-color:transparent!important;">
                        ...
                        <li class="breadcrumb-item active" aria-current="page" style="font-size:18px;color:white;">Contact</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<section style="background-color:#8382801f;">
                    ...
                    <div class="contact_info_container d-flex flex-lg-row flex-column justify-content-between align-items-between">
                        ...
                        <div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
                            ...
                            <div class="contact_info_content">
                                ...
                                <div class="contact_info_text">6391770011, 6391770022, 9235441140</div>
                            </div>
                        </div>
                        ...
                        <div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
                            ...
                            <div class="contact_info_content">
                                ...
                                <div class="contact_info_text">rknetralayaeye@gmail.com</div>
                            </div>
                        </div>
                        ...
                        <div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
                            ...
                            <div class="contact_info_content">
                                ...
                                <div class="contact_info_text"> Dayal Enclave, D-63/B-10 A-1, Mahmoorganj</div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="contact_form_container">
                        <h2 class="section_heading text-center">Get in touch</h2>
                        <p class="heading_p" style="color:black;text-align:center;">Lorem ipsum dolor sit amet.</p>

                        <form action="{{route('contact_store')}}" id="contact_form" method="POST">
                            @csrf
...
<section class="py-5">
    <div class="container">
        <div class="mapouter">
            <div class="gmap_canvas"><iframe width="100%" height="300px" id="gmap_canvas" src="https://maps.google.com/maps?q=rk%20netralaya%20&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://123movies-a.com"></a><br>
                <style>
                    .mapouter {
                        text-align: right;
                        width: 100%;
