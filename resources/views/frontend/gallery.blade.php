...
<style>
    .gallery_bnr {
        background-image: url('https://rubyhall.com/img/bg/Opthalmology.jpg');
            ...
            <div class="col-md-2">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb" style="background-color:transparent!important;">
                        ...
                        <li class="breadcrumb-item active" aria-current="page" style="font-size:18px;color:white;">Gallery</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center my-2">
                <h3 class="py-3 section_heading">Gallery</h3>
                <h4></h4>
            </div>
        </div>
        ...
        <div class="portfolio-item row">
            ...
            <div class="item selfie col-lg-3 col-md-4 col-6 col-sm">
                <a href="{{ asset('galleries/' . $images->images) }}" class="fancylight popup-btn" data-fancybox-group="light">
                    <img class="img-fluid" src="{{ asset('galleries/' . $images->images) }}" alt="">
                </a>
            </div>
            @endforeach
